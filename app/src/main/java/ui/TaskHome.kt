...
fun TaskHome(modifier: Modifier = Modifier) {
    val tasks = remember {
        mutableStateListOf(
            Task(label = "Ranger la chambre"),
            Task(label = "Crée le todo"),
            Task(label = "Course", "Pates, riz, blé")
        )
    }
    ...
    Column(
        ...
        Button(onClick = { showAddDialog = true }) { Text("Add TODO") }
            ...
            text = {
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        singleLine = true,
                        label = { Text("Todo") },
                        placeholder = { Text("Right your todo here...") }
                    )
                    OutlinedTextField(
                        value = addDesc,
                    ...
                    Row(
                        ...
                        TextButton(onClick = { showAddDatePicker = true }) { Text("Choose") }
                    }
                }
            },
            confirmButton = {
            ...
            text = {
                Column(
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        TextButton(onClick = { showEditDatePicker = true }) { Text("Chose") }
                    }
                }
            },
            confirmButton = {
